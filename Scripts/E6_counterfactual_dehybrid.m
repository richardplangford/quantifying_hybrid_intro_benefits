...
% Continues in the same way as the hybrid characteristic removal CF
X(:,10) = zeros(cdindex(T),1);
C(:,10) = zeros(cdindex(T),1);
IV(:,10) = zeros(cdindex(T),1);
...
save('counterfactuals_dehybrid.mat');
